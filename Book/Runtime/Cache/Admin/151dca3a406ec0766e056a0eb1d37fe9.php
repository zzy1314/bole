...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F<?php echo ('%y-%M-%d'($dp["$D('datemax')"])); ?>'})" id="datemin" class="input-text Wdate" style="width:180px;">
			</div>
